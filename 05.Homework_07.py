...
list_profit = []
new_dict = {}
with open('05.Homework_07.txt', 'r', encoding='utf-8') as company_info:
    my_file = company_info.readlines()
    for i in my_file:
    ...
    average_profit = round(sum(list_profit)/len(list_profit), 0)
    new_dict_2 = {'average_profit': average_profit}
    my_list = [new_dict, new_dict_2]
    with open('05.Homework_07.json', 'w') as write_f:
